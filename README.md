...
quick&dirty incomplete mostly vibe-coded and totally unsupported emscripten port of the good old einstein puzzle game

(based on this sdl2 port https://github.com/nunolucas/einstein-puzzle)

multiple things don't work, but it is playable.
when the screen scales incorrectly when starting a new game, esc back to main menu and retry.
ideally make sure the original aspect ratio is correct for proper mouse mapping.
I won't fix anything here, you'r eon your own.
